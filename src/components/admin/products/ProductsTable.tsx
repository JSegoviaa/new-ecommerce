...
const ProductsTable: FC<Props> = (props) => {
  const { products, limit, page, setOffset, setLimit, setPage, size } = props;
        ...
        <TableBody>
          {products?.products.map((product) => (
            ...
            >
              ...
              <TableCell align="center" component="th" scope="row">
                {formatedDate(product.updatedAt)}
              </TableCell>
              ...
              <TableCell align="center" component="th" scope="row">
                <Typography>{product.isPublished ? 'Sí' : 'No'}</Typography>
              </TableCell>
              <TableCell align="center" component="th" scope="row">
                <Typography>{product.isActive ? 'Sí' : 'No'}</Typography>
              </TableCell>
            </TableRow>
          ))}
        </TableBody>
